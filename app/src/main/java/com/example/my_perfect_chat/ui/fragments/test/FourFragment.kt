...
import com.example.my_perfect_chat.databinding.FragmentFourBinding
...
class FourFragment : BaseFragment(R.layout.fragment_four) {
    ...
    private val nameDataPerson1 = database.getReference("4name1")
    private val nameDataPerson2 = database.getReference("4name2")
    private val nameDataPerson3 = database.getReference("4name3")
    private val nameDataPerson4 = database.getReference("4name4")
    private val nameDataPerson5 = database.getReference("4name5")
    private val nameDataPerson6 = database.getReference("4name6")
    private val nameDataPerson7 = database.getReference("4name7")
    private val nameDataPerson8 = database.getReference("4name8")

    private val ballData1 = database.getReference("4ball1")
    private val ballData2 = database.getReference("4ball2")
    private val ballData3 = database.getReference("4ball3")
    private val ballData4 = database.getReference("4ball4")
    private val ballData5 = database.getReference("4ball5")
    private val ballData6 = database.getReference("4ball6")
    private val ballData7 = database.getReference("4ball7")
    private val ballData8 = database.getReference("4ball8")

    private val ballDataDop1 = database.getReference("4ballDop1")
    private val ballDataDop2 = database.getReference("4ballDop2")
    private val ballDataDop3 = database.getReference("4ballDop3")
    private val ballDataDop4 = database.getReference("4ballDop4")
    private val ballDataDop5 = database.getReference("4ballDop5")
    private val ballDataDop6 = database.getReference("4ballDop6")
    private val ballDataDop7 = database.getReference("4ballDop7")
    private val ballDataDop8 = database.getReference("4ballDop8")
