...
import com.example.my_perfect_chat.databinding.FragmentFiveBinding
...
class FiveFragment : BaseFragment(R.layout.fragment_five) {
    ...
    private val nameDataPerson1 = database.getReference("5name1")
    private val nameDataPerson2 = database.getReference("5name2")
    private val nameDataPerson3 = database.getReference("5name3")
    private val nameDataPerson4 = database.getReference("5name4")
    private val nameDataPerson5 = database.getReference("5name5")
    private val nameDataPerson6 = database.getReference("5name6")
    private val nameDataPerson7 = database.getReference("5name7")
    private val nameDataPerson8 = database.getReference("5name8")

    private val ballData1 = database.getReference("5ball1")
    private val ballData2 = database.getReference("5ball2")
    private val ballData3 = database.getReference("5ball3")
    private val ballData4 = database.getReference("5ball4")
    private val ballData5 = database.getReference("5ball5")
    private val ballData6 = database.getReference("5ball6")
    private val ballData7 = database.getReference("5ball7")
    private val ballData8 = database.getReference("5ball8")

    private val ballDataDop1 = database.getReference("5ballDop1")
    private val ballDataDop2 = database.getReference("5ballDop2")
    private val ballDataDop3 = database.getReference("5ballDop3")
    private val ballDataDop4 = database.getReference("5ballDop4")
    private val ballDataDop5 = database.getReference("5ballDop5")
    private val ballDataDop6 = database.getReference("5ballDop6")
    private val ballDataDop7 = database.getReference("5ballDop7")
    private val ballDataDop8 = database.getReference("5ballDop8")
