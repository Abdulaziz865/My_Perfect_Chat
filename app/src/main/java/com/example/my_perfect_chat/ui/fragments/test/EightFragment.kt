...
import com.example.my_perfect_chat.databinding.FragmentEightBinding
...
class EightFragment : BaseFragment(R.layout.fragment_eight) {

    private val binding by viewBinding(FragmentEightBinding::bind)
    private val database = Firebase.database

    private val nameDataPerson1 = database.getReference("8name1")
    private val nameDataPerson2 = database.getReference("8name2")
    private val nameDataPerson3 = database.getReference("8name3")
    private val nameDataPerson4 = database.getReference("8name4")
    private val nameDataPerson5 = database.getReference("8name5")
    private val nameDataPerson6 = database.getReference("8name6")
    private val nameDataPerson7 = database.getReference("8name7")
    private val nameDataPerson8 = database.getReference("8name8")

    private val ballData1 = database.getReference("8ball1")
    private val ballData2 = database.getReference("8ball2")
    private val ballData3 = database.getReference("8ball3")
    private val ballData4 = database.getReference("8ball4")
    private val ballData5 = database.getReference("8ball5")
    private val ballData6 = database.getReference("8ball6")
    private val ballData7 = database.getReference("8ball7")
    private val ballData8 = database.getReference("8ball8")

    private val ballDataDop1 = database.getReference("8ballDop1")
    private val ballDataDop2 = database.getReference("8ballDop2")
    private val ballDataDop3 = database.getReference("8ballDop3")
    private val ballDataDop4 = database.getReference("8ballDop4")
    private val ballDataDop5 = database.getReference("8ballDop5")
    private val ballDataDop6 = database.getReference("8ballDop6")
    private val ballDataDop7 = database.getReference("8ballDop7")
    private val ballDataDop8 = database.getReference("8ballDop8")
