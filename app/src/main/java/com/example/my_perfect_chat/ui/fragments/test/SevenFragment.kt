...
import com.example.my_perfect_chat.databinding.FragmentSevenBinding
...
class SevenFragment : BaseFragment(R.layout.fragment_seven) {

    private val binding by viewBinding(FragmentSevenBinding::bind)
    private val database = Firebase.database

    private val nameDataPerson1 = database.getReference("7name1")
    private val nameDataPerson2 = database.getReference("7name2")
    private val nameDataPerson3 = database.getReference("7name3")
    private val nameDataPerson4 = database.getReference("7name4")
    private val nameDataPerson5 = database.getReference("7name5")
    private val nameDataPerson6 = database.getReference("7name6")
    private val nameDataPerson7 = database.getReference("7name7")
    private val nameDataPerson8 = database.getReference("7name8")

    private val ballData1 = database.getReference("7ball1")
    private val ballData2 = database.getReference("7ball2")
    private val ballData3 = database.getReference("7ball3")
    private val ballData4 = database.getReference("7ball4")
    private val ballData5 = database.getReference("7ball5")
    private val ballData6 = database.getReference("7ball6")
    private val ballData7 = database.getReference("7ball7")
    private val ballData8 = database.getReference("7ball8")

    private val ballDataDop1 = database.getReference("7ballDop1")
    private val ballDataDop2 = database.getReference("7ballDop2")
    private val ballDataDop3 = database.getReference("7ballDop3")
    private val ballDataDop4 = database.getReference("7ballDop4")
    private val ballDataDop5 = database.getReference("7ballDop5")
    private val ballDataDop6 = database.getReference("7ballDop6")
    private val ballDataDop7 = database.getReference("7ballDop7")
    private val ballDataDop8 = database.getReference("7ballDop8")
