...
import com.example.my_perfect_chat.databinding.FragmentTwoBinding
...
class TwoFragment : BaseFragment(R.layout.fragment_two) {
    ...
    private val nameDataPerson1 = database.getReference("2name1")
    private val nameDataPerson2 = database.getReference("2name2")
    private val nameDataPerson3 = database.getReference("2name3")
    private val nameDataPerson4 = database.getReference("2name4")
    private val nameDataPerson5 = database.getReference("2name5")
    private val nameDataPerson6 = database.getReference("2name6")
    private val nameDataPerson7 = database.getReference("2name7")
    private val nameDataPerson8 = database.getReference("2name8")

    private val ballData1 = database.getReference("2ball1")
    private val ballData2 = database.getReference("2ball2")
    private val ballData3 = database.getReference("2ball3")
    private val ballData4 = database.getReference("2ball4")
    private val ballData5 = database.getReference("2ball5")
    private val ballData6 = database.getReference("2ball6")
    private val ballData7 = database.getReference("2ball7")
    private val ballData8 = database.getReference("2ball8")

    private val ballDataDop1 = database.getReference("2ballDop1")
    private val ballDataDop2 = database.getReference("2ballDop2")
    private val ballDataDop3 = database.getReference("2ballDop3")
    private val ballDataDop4 = database.getReference("2ballDop4")
    private val ballDataDop5 = database.getReference("2ballDop5")
    private val ballDataDop6 = database.getReference("2ballDop6")
    private val ballDataDop7 = database.getReference("2ballDop7")
    private val ballDataDop8 = database.getReference("2ballDop8")
