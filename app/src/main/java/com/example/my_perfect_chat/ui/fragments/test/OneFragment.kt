...
import com.example.my_perfect_chat.databinding.FragmentOneBinding
...
class OneFragment : BaseFragment(R.layout.fragment_one) {
    ...
    private val nameDataPerson1 = database.getReference("1name1")
    private val nameDataPerson2 = database.getReference("1name2")
    private val nameDataPerson3 = database.getReference("1name3")
    private val nameDataPerson4 = database.getReference("1name4")
    private val nameDataPerson5 = database.getReference("1name5")
    private val nameDataPerson6 = database.getReference("1name6")
    private val nameDataPerson7 = database.getReference("1name7")
    private val nameDataPerson8 = database.getReference("1name8")

    private val ballData1 = database.getReference("1ball1")
    private val ballData2 = database.getReference("1ball2")
    private val ballData3 = database.getReference("1ball3")
    private val ballData4 = database.getReference("1ball4")
    private val ballData5 = database.getReference("1ball5")
    private val ballData6 = database.getReference("1ball6")
    private val ballData7 = database.getReference("1ball7")
    private val ballData8 = database.getReference("1ball8")

    private val ballDataDop1 = database.getReference("1ballDop1")
    private val ballDataDop2 = database.getReference("1ballDop2")
    private val ballDataDop3 = database.getReference("1ballDop3")
    private val ballDataDop4 = database.getReference("1ballDop4")
    private val ballDataDop5 = database.getReference("1ballDop5")
    private val ballDataDop6 = database.getReference("1ballDop6")
    private val ballDataDop7 = database.getReference("1ballDop7")
    private val ballDataDop8 = database.getReference("1ballDop8")
